...
foreach($tbTables as $k=>$v){
        $tabColTitle = array("cid"=>"บัตรประชาชน","cname"=>"ชื่อ-สกุล",
            "dtype"=>"ประเภทขับขี่", "did"=>"เลขที่บัตร" , "dout"=>"วันที่ออกบัตร" , "dexp"=>"วันหมดอายุ" ,"");
        $tb_name = $k;
        $tb_title = $v;
        ...
        $datadb = getMYSQLValueAll("{$tb_name} as x , hr_person as y ",
            ...
            " (select name from hr_dtype as ps where ps.id = x.dtype ) as dtype , x.did,x.dout,x.dexp,x.id" ,
