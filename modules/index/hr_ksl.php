                        ...
                        <div class="col-md-3">
                                ...
                                <div class="box box-primary">
                                        <div class="box-body box-profile">
                                                <img class="profile-user-img img-responsive img-circle"
                                                     src="<?=SERVER_NAME?>/../assets/dist/img/user4.png" alt="User profile picture">
                                ...
                                <div class="box box-primary">
                                        ...
                                        <div class="box-body">
                                                ...
                                                <p style="margin-top: 20px;"> <span class="label label-danger"> UI Design </span> </p>
                                                <p style="margin-top: 20px;"> <span class="label label-danger"> UI Design </span> </p>
                                                <p style="margin-top: 20px;"> <span class="label label-danger"> UI Design </span> </p>
                                                <p style="margin-top: 20px;"> <span class="label label-danger"> UI Design </span> </p>
                                                <p style="margin-top: 20px;"> <span class="label label-danger"> UI Design </span> </p>
                                                                ...
                                                                <li>
                                                                        ...
                                                                        <div class="timeline-item">
                                                                                ...
                                                                                <div class="timeline-footer">
                                                                                        <a class="btn btn-primary btn-xs">Read
                                                                                                more</a>
